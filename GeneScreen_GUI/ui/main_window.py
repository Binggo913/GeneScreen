...
from ui.theme import STATIC_THEME_STYLESHEET, build_palette, get_theme_tokens
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self._theme_stylesheet_installed = False
    ...
    def _install_theme_stylesheet_once(self):
        app = QApplication.instance()
        if not app or self._theme_stylesheet_installed:
            return
        app.setStyleSheet(f"{self._base_app_stylesheet}\n{STATIC_THEME_STYLESHEET}")
        self._theme_stylesheet_installed = True

    def _apply_app_palette(self, tokens):
        app = QApplication.instance()
        if not app:
            return
    ...
    def _apply_styles(self):
        ...
        self._apply_app_palette(tokens)
        self._install_theme_stylesheet_once()
