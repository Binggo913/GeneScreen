...
def main(args_input):
    ...
    if(args.karyotype):
        ...
        if not relations:
            raise FatalError(2,'')
        while 1 :
            if not relations or ('isNew' in relations[0]):
                break
            else:
...
#==================creat svg=================
    ...
    if (args.highlight):
        ...
        for line in H:
            ...
            for chro in chros:
                ...
                # 设置最小宽度为 2px
                if highlight_width < 2: highlight_width = 2
    ...
    for svg_content_partial in [svg_content_style, svg_content_line, svg_content_chro, svg_content_label, svg_content_align, svg_content_scale, svg_content_axis, svg_content_gene, svg_content_highlight, svg_content_clipPath]:
