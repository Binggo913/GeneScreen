...
整合自 CLI 版本的 GeneScreenVisualizer.py:
...
class LinkviewVisualizer:
    ...
    def run_linkview(
        ...
        linkview_path = os.path.join(script_dir, "..", "..", "GeneScreen_1.0", "bin", "LINKVIEW.py")
...
<head>
    ...
    <title>GeneScreen 1.0 - {result_id}</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>Generated by GeneScreen 1.0 | {datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")}</p>
        </div>
    </div>
</body>
</html>'''
